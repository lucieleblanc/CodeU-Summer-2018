...
public class PersistentDataStoreTest {
  ...
  public void testSaveAndLoadUsers() throws PersistentDataStoreException {
    ...
    String bioOne = "test_bio_one";
    User inputUserOne = new User(idOne, nameOne, passwordHashOne, creationOne, bioOne);
    ...
    String bioTwo = "test_bio_two";
    User inputUserTwo = new User(idTwo, nameTwo, passwordHashTwo, creationTwo, bioTwo);
